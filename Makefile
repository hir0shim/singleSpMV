...
# OPT_SS  : SIMPLE
# OPT_CSS : N_BLOCK
MIC_OPTION = $(OPTION) -DMIC -DVERIFY -DOPT_CSS -DN_BLOCK=32 -DINDEX_32 -DSIMPLE -DALIGNMENT=64 
CPU_OPTION = $(OPTION) -DCPU -DVERIFY -DOPT_CSS -DN_BLOCK=32 -DINDEX_32 -DALIGNMENT=32 -xCORE-AVX2
