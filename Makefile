...
# OPT_SS  : SIMPLE OPTIMIZED PADDING
# OPT_CSS : SIMPLE OPTIMIZED N_BLOCK PADDING
MIC_OPTION += $(OPTION) -DMIC -DVERIFY -DOPT_SS -DOPTIMIZED -DPADDING -DINDEX_32 -DALIGNMENT=64 $(CMDLINE_OPTION)
CPU_OPTION += $(OPTION) -DCPU -DVERIFY -DOPT_SS -DOPTIMIZED -DPADDING -DINDEX_32 -DALIGNMENT=32 -xCORE-AVX2 $(CMDLINE_OPTION)
