...
# Common  		: INDEX_[32,64], VERIFY, ALIGNMENT
# Format  		: OPT_[CRS,MKL,CUSPARSE,JDS,ELL,COO,SS,CSS]
# OPT_SS  		: [SIMPLE,OPTIMIZED] PADDING, SEGMENT_WIDTH, MEASURE_STEP_TIME, PADDING, PADDING_SIZE
# OPT_CSS 		: [SIMPLE,OPTIMIZED] SEGMENT_WIDTH, N_BLOCK, PROFILING
# --- Params List End ---

OPTION = -DOPT_SS -DOPTIMIZED -DSEGMENT_WIDTH=1024 -DPROFILING
MIC_OPTION = $(OPTION) -DMIC -DINDEX_32 -DALIGNMENT=64 
