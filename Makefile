...
# OPT_SS  : SIMPLE
# OPT_CSS : N_BLOCK
MIC_OPTION += $(OPTION) -DMIC -DVERIFY -DOPT_SS -DPADDING -DINDEX_32 -DALIGNMENT=64 $(CMDLINE_OPTION)
CPU_OPTION += $(OPTION) -DCPU -DVERIFY -DOPT_SS -DPADDING -DINDEX_32 -DALIGNMENT=32 -xCORE-AVX2 $(CMDLINE_OPTION)
